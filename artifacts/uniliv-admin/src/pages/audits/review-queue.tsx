 ...
 *  loop with a fail-first hero and a module-health rail. Rendered standalone at
...
export function ReviewQueuePanel({ embedded = false }: { embedded?: boolean }) {
  ...
  const main = (
    <div className="min-w-0">
      <div className="mb-4 flex flex-wrap items-center gap-3">
        ...
        <div className={cn("flex flex-wrap gap-1.5", embedded && "flex-1")}>
  ...
  if (embedded) {
    return <div className="animate-fade-up">{main}{dialog}</div>;
  }
  return (
