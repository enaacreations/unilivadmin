...
import { MapPin, Loader2, Star, Trash2, ImageIcon } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
// Photos section — gallery + upload + hero/delete controls. Edit-only (needs an id).
function PropertyPhotosSection({ propertyId }: { propertyId: string }) {
